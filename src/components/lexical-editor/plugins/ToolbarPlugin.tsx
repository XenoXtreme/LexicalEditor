      ...
      editor.registerCommand<ImagePayload>(
        ...
        (payload) => {
          ...
          editor.update(() => {
            ...
            const imageNode = $createImageNode({ altText, src, width, height, showCaption });
            const selection = $getSelection();
            if ($isRangeSelection(selection)) {
        ...
        <DropdownMenuContent className="w-60">
          ...
          <DropdownMenuSeparator />
           <DropdownMenuItem onClick={() => formatElement('outdent')}>
              ...
              {ALIGNMENT_OPTIONS.find(o => o.value === 'outdent')?.shortcut && <DropdownMenuShortcut>{ALIGNMENT_OPTIONS.find(o => o.value === 'outdent')?.shortcut}</DropdownMenuShortcut>}
            </DropdownMenuItem>
            <DropdownMenuItem onClick={() => formatElement('indent')}>
              <Indent className="mr-2 h-4 w-4" />
              <span className="flex-grow">Indent</span>
              {ALIGNMENT_OPTIONS.find(o => o.value === 'indent')?.shortcut && <DropdownMenuShortcut>{ALIGNMENT_OPTIONS.find(o => o.value === 'indent')?.shortcut}</DropdownMenuShortcut>}
            </DropdownMenuItem>
        </DropdownMenuContent>
      </DropdownMenu>
